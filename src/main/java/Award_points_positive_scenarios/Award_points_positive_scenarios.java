...
public class Award_points_positive_scenarios extends Generic_functions{
	...
	public static void app_is_open() {
		try {
			...
			click("welcome_login");
			page_wait(30);
			driver.findElement(By.xpath(OR_reader("Object Locator","login_phone_number"))).sendKeys(td_reader("login_phone_number",6));
			driver.findElement(By.xpath(OR_reader("Object Locator","login_password"))).sendKeys(td_reader("login_password",4));
			page_wait(20);
			click("login");	
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static void Award_point_positive_tc_003() throws IOException {
		try {
			...
			page_wait(5);
			value = driver.findElement(By.xpath(OR_reader("Object Locator", "redeem_award_points_title"))).isDisplayed();
			Assert.assertEquals(true,value);
			...
			driver.findElement(By.xpath(OR_reader("Object Locator","redeem_points_amount"))).sendKeys(td_reader("redeem_points_amount",2));
