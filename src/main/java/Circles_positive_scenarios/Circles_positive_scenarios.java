...
public class Circles_positive_scenarios extends Generic_functions{
	...
	public void circle_positive_tc_006() throws IOException {
		try {
			driver.findElement(By.xpath(OR_reader("Object Locator", "circles_mymedicare_username"))).sendKeys(td_reader("circles_mymedicare_username"));
			driver.findElement(By.xpath(OR_reader("Object Locator", "circles_mymedicare_password"))).sendKeys(td_reader("circles_mymedicare_password"));
		} catch (Exception e) {
			e.printStackTrace();
